...
class Related_News_Widget extends \Elementor\Widget_Base
{

    public function get_name()
    {
        return 'Related_News_Widget';
    }

    public function get_title()
    {
        return __('Related News', 'child_theme');
    }
    ...
    protected function render()
    {
        ...
        $args = array(
            ...
            'posts_per_page' => 3, // Số bài viết muốn hiển thị
        ...
        if ($related_posts->have_posts()) {
            ...
            while ($related_posts->have_posts()) {
                ...
                ?>
                <article class="related_news_item" data-mh="related_news_item">
                    <div class="row related_news_item__row">
                        <?php if (has_post_thumbnail()): ?>
                            <div class="col-4">
                                <div class="related_news_item__image">
                                    <a class="d-block related_news_item__img" href="<?php the_permalink(); ?>">
